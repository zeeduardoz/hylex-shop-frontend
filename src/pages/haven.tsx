...
const info = {
  page: 'HAVEN',
  description:
    'Sobreviva a um mundo pós apocalíptico! Onde zombies não são sua única ameaça.'
}
...
export default function Haven() {
  ...
  useEffect(() => {
    ...
    api
      .get(
        `/shopping/getProductsByCategory?category=6&perPage=20&currentPage=1`
      )
      .then(response => {
  ...
  return (
    <Layout title="Haven" header={info}>
