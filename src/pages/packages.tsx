...
const info = {
  page: 'Pacotes',
  description:
    'Conheça nossos pacotes e obtenha diversos itens, cosméticos, e vantagens exclusivas!'
}
...
export default function Packages() {
  ...
  useEffect(() => {
    ...
    api
      .get(
        `/shopping/getProductsByCategory?category=8&perPage=20&currentPage=1`
      )
      .then(response => {
  ...
  return (
    <Layout title="Pacotes" header={info}>
