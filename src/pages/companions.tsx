...
const info = {
  page: 'Companheiros',
  description:
    'Conheça seus companheiros, eles estarão ao seu lado em todos os lobbys do servidor!'
}
...
export default function Companions() {
  ...
  useEffect(() => {
    ...
    api
      .get(
        `/shopping/getProductsByCategory?category=7&perPage=20&currentPage=1`
      )
      .then(response => {
  ...
  return (
    <Layout title="Companheiros" header={info}>
                  ...
                  <div className="m-3 flex flex-col items-center justify-between rounded-md bg-primary">
                    ...
                    <div className="px-5 py-5">
                      {product.oldPrice === '0' ? (
                        ...
                        <p className="text-center font-light text-red-300 line-through">
                          <small>R$</small> {product.oldPrice}
                        </p>
                      )}
                      <p className="text-center text-2xl font-light text-color-medium">
