...
const info = {
  page: 'Boosters',
  description: 'Venha conhecer nosso multiplicador de coins!'
}
...
export default function Boosters() {
  ...
  useEffect(() => {
    ...
    api
      .get(
        `/shopping/getProductsByCategory?category=5&perPage=20&currentPage=1`
      )
      .then(response => {
  ...
  return (
    <Layout title="Boosters" header={info}>
