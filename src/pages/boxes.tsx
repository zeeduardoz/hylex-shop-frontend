...
const info = {
  page: 'Caixas Misteriosas',
  description:
    'Adquira Caixas Misteriosas para ganhar as premiações mais raras e divertidas.'
}
...
export default function Boxes() {
  ...
  useEffect(() => {
    ...
    api
      .get(
        `/shopping/getProductsByCategory?category=4&perPage=20&currentPage=1`
      )
      .then(response => {
  ...
  return (
    <Layout title="Caixas Misteriosas" header={info}>
