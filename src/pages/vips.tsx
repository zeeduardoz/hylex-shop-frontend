...
const info = {
  page: 'VIPS',
  description:
    'Venha já conhecer as diversas vantagens que nossos Vips oferecem!'
}
...
export default function Ranks() {
  ...
  useEffect(() => {
    ...
    api
      .get(
        `/shopping/getProductsByCategory?category=1&perPage=20&currentPage=1`
      )
      .then(response => {
  ...
  return (
    <Layout title="Ranks" header={info}>
